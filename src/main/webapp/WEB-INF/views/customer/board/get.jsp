...
<body>
<h1>조회 페이지</h1>
<form id="infoForm" action="/customer/board/modifyPage" method="POST">
<input type="hidden" id="bno" name="bno" value='<c:out value="${pageInfo.bno}"/>'>
	...
	<div class="btn_wrap">
		...
		<button class="btn" type="button" onclick="removeBoard(this.form);">삭제하기</button>
...
function removeBoard(form){
	if(confirm("削除しますか？")){
		form.action = "/customer/board/delete";
		form.method = "post";
		form.submit();
	}
}
